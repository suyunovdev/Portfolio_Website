...
const About = () => {
  ...
  return (
    <div
      data-aos="fade-up"
      className="flex items-center justify-center w-full h-screen bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-center"
    >
      <div className="left w-[80%] md:w-[60%] lg:w-[50%] p-6 gap-5 flex flex-col bg-white rounded-lg shadow-2xl bg-opacity-80 backdrop-blur-md">
        ...
        >
          I’m Evren Shah, a passionate developer with a keen eye for design. I
          have been in the web industry for years, constantly honing my skills
